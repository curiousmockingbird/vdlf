...
function get_default_settings()
{
    ...
    $settings = [
        ...
        'pressPage'         => get_field("press_page_".$language, "option") ?? get_field("press_page", "option"),
        'donatePage'        => get_field("donate_page_".$language, "option") ?? get_field("donate_page", "option"),
        'membershipPage'    => get_field("membership_page_".$language, "option") ?? get_field("membership_page", "option"),
...
function get_setting_translations()
{
    return [
        ...
        "language"         => __("Language","sage"),
        "type_here"        => __("Type here", "sage"),
        "load_more"        => __("Load More", "sage"),
        "no_data_found"    => __("No data found", "sage"),
        "latest_first"     => __('Latest First',"sage"),
        "oldest_first"     => __('Oldest First',"sage"),
        "featured"         => __('Featured',"sage"),
        "continue_reading" => __('Continue Reading',"sage"),
        "topic"            => __('Topic',"sage"),
        "year"             => __('Year',"sage"),
        "month"            => __('Month',"sage"),
        "january"          => __('January',"sage"),
        "february"         => __('February',"sage"),
        "march"            => __('March',"sage"),
        "april"            => __('April',"sage"),
        "may"              => __('May',"sage"),
        "june"             => __('June',"sage"),
        "july"             => __('July',"sage"),
        "august"           => __('August',"sage"),
        "september"        => __('September',"sage"),
        "october"          => __('October',"sage"),
        "november"         => __('November',"sage"),
